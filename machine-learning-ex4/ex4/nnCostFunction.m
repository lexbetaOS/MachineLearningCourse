...
inden=eye(num_labels);
for i=1:m
%J=J+(1/m)*((inden(:,y(i))'*log(a3)
Y(i,:)=inden(:,y(i))';
end
...
Theta1_gradtemp=Theta1_grad/m;
Theta2_gradtemp=Theta2_grad/m;

Theta1_grad=(Theta1_grad/m)+lambda/m*Theta1;
Theta1_grad(:,1)=Theta1_gradtemp(:,1);

Theta2_grad=(Theta2_grad/m)+lambda/m*Theta2;
Theta2_grad(:,1)=Theta2_gradtemp(:,1);
% -------------------------------------------------------------
